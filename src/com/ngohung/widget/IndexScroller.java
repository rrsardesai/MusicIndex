...
import psych.android.aml.fling.Records;
...
public class IndexScroller {
	...
	public void drawCurrentSection(Canvas canvas) {
		if (mCurrentSection >= 0) {
			...
			if (!Records.mute) {
				if (!mp.isPlaying()) {
					if (mSections[mCurrentSection].equals("A")) {
					...
					} else if (mSections[mCurrentSection].equals("B")) {
					...
					} else if (mSections[mCurrentSection].equals("C")) {
					...
					} else if (mSections[mCurrentSection].equals("D")) {
					...
					} else if (mSections[mCurrentSection].equals("E")) {
					...
					} else if (mSections[mCurrentSection].equals("F")) {
					...
					} else if (mSections[mCurrentSection].equals("G")) {
					...
					} else if (mSections[mCurrentSection].equals("H")) {
					...
					} else if (mSections[mCurrentSection].equals("I")) {
					...
					} else if (mSections[mCurrentSection].equals("J")) {
					...
					} else if (mSections[mCurrentSection].equals("K")) {
					...
					} else if (mSections[mCurrentSection].equals("L")) {
					...
					} else if (mSections[mCurrentSection].equals("M")) {
					...
					} else if (mSections[mCurrentSection].equals("N")) {
					...
					} else if (mSections[mCurrentSection].equals("O")) {
					...
					} else if (mSections[mCurrentSection].equals("P")) {
					...
					} else if (mSections[mCurrentSection].equals("Q")) {
					...
					} else if (mSections[mCurrentSection].equals("R")) {
					...
					} else if (mSections[mCurrentSection].equals("S")) {
					...
					} else if (mSections[mCurrentSection].equals("T")) {
					...
					} else if (mSections[mCurrentSection].equals("U")) {
					...
					} else if (mSections[mCurrentSection].equals("V")) {
					...
					} else if (mSections[mCurrentSection].equals("W")) {

						try {
							mp = MediaPlayer.create(c, R.raw.w);
					...
					} else if (mSections[mCurrentSection].equals("X")) {

						try {
							mp = MediaPlayer.create(c, R.raw.x);
					...
					} else if (mSections[mCurrentSection].equals("Y")) {
					...
					} else if (mSections[mCurrentSection].equals("Z")) {
